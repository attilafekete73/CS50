...
def person(person):
    ...
    if request.method == "GET":
        ...
        submissions=sess.query(dbhead.Document.name,dbhead.Document.path).join(dbhead.User, dbhead.Document.userid==dbhead.User.id).filter(dbhead.User.username==person).all()
